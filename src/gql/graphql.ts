...
export type ProductsGetByCategorySlugQuery = { category?: { products: Array<{ name: string, description: string, id: string, price: number, images: Array<{ url: string, alt: string }> }> } | null };
